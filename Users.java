...
public class Users {
	...
	public static void main(String[] args) {
		...
		DisplayPrices additionalServices = new DisplayPrices();
		CountComp linearSearch = new CountComp();

		SearchCompanyBasedOnProfit binearySearchImplementation = new SearchCompanyBasedOnProfit();
